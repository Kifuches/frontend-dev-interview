...
Материал частично основан на статье Доки
[«Хранение по ссылке и по значению»](https://doka.guide/js/ref-type-vs-value-type/).

Оригинальный текст: Doka Community и авторы статьи.
Лицензия оригинального текста: [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/).
Текст переработан и адаптирован для личных учебных конспектов.

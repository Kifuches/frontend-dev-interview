...
Важно: Ищи сервис только в текущем Injector.
...
Важно: Не смотри в текущем Injector. Начинай поиск выше.
...
Важно: Не выходи за пределы Host Component.
...
Важно: Если сервис найден — получаем его. Если нет — получаем null вместо ошибки.
